...
- 🗺️ **Grande carte carrée entièrement ouverte** (grille 13×13, 169 cases) avec un sol texturé en véritable quadrillage aligné case par case, une bordure de **montagnes, rochers et arbres morts** tout autour façon Clash of Clans, et une caméra positionnée par défaut selon l'angle diamant classique. Toute la zone constructible est disponible dès le début — pas de parcelles verrouillées à débloquer.
